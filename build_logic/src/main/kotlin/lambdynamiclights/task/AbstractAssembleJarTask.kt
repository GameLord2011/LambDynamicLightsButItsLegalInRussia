...
abstract class AbstractAssembleJarTask @Inject constructor() : Jar() {
	...
	companion object {
		val DEFAULT_DIR_MODE: Set<PosixFilePermission> = PosixFilePermissions.fromString("rwxr-xr-x")
		val DEFAULT_FILE_MODE: Set<PosixFilePermission> = PosixFilePermissions.fromString("rw-r--r--")
		val ZIP_EPOCH_TIME: FileTime = FileTime.from(
			OffsetDateTime.of(
				1980, 2, 1,
				0, 0, 0, 0,
		...
		val NO_DATA_TIME: FileTime = FileTime.fromMillis(-1)
	}
}
